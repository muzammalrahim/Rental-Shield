...
import Mostreadimg from '../../assets/images/home.jpg';
...
export default class Mostread extends Component {
    render() {
        return (
            ...
            <div style={{ backgroundImage:`url(${Mostreadimg})` }} class="h-52 sm:h-full sm:w-72 rounded-xl bg-gray-100 bg-center bg-cover">
