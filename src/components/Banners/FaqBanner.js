        ...
        return (
            <div className="sm:home-banner-main   xs:home-banner-main">
                ...
                <Col xs="3" sm="5" md="4" lg="4">
                    <div className="xs:left-side lg:left-side sm:left-side bg-local mt-56" style={{ backgroundImage:`url(${Homebanner})` }}>
                ...
                <Col xs="9" sm="7" md="4" lg="4">
                    <div className="sm:right-inner pb-5  xs:right-inner inner bg-local min-h-screen" style={{ backgroundImage:`url(${RightBg})` }}>
                        <div className="sm:inner xs:inner md:inner-pt-5 lg:inner">
