    ...
    render() {
        return (
            <div className="know-more-mian">
                <div className="know-more-head">
                    <h4 className="text-gray-500 font-body lg:text-6xl md:text-6xl text-xl font-normal pb-3 m-0">
                    ...
                    <div className="know-inner bg-no-repeat bg-center pt-100 bg-local" style={{ backgroundImage:`url(${KnowBg})` }}>
                        <div className="row1">
                            <div className="relative">
                                <div className="para1 text-left absolute w-1/4">
                                    <h4 className="text-gray-500 font-body font-bold pb-2 text-xl">I'm a Landlord</h4>
                                    <p className="know-more-p  text-gray-500  font-body text-base lg:text-lg leading-5 pb-3 font-normal">
                                        Why does this benefit me? Can I still protect
                                        my interests? How do I ensure fairness? 
                                        What if I want to dispute?
                                    </p>
                                    <button className="bg-green-900 font-body rounded-full mt-2 px-4 py-1.5 text-base text-white font-bold">
                                        View more
                                    </button>
                                </div>
                            </div>
                            <div className="relative">
                                <div className="para2 text-left absolute">
                                    <h4 className="text-gray-500  font-body font-bold pb-2 text-xl">I'm a propert manager</h4>
                                    <p className="know-more-p text-gray-500  font-body text-lg font-normla  pb-3 leading-5">
                                    ...
                                    <button className="bg-green-900 font-body mt-2 rounded-full px-4 py-1.5 text-base text-white font-bold">
                                        View more
                                    </button>
                                </div>
                            </div>
                        ...
                        <div className="relative">
                            <div className="para3 text-center absolute  w-1/4">
                                <h4 className="text-gray-500 font-body  pb-2 font-bold text-xl ">I'm an Agent</h4>
                                <p className="know-more-p  text-gray-500  font-body text-lg font-normal pb-3 leading-5">
                                Make this your. Add images, text and links, or
                                connect data from your collection.
                                </p>
                                <button className="bg-green-900 mt-2 font-body rounded-full px-4 py-1.5 text-base text-white font-bold">
                                    View more
                                </button>
                            </div>
                            </div>
                            ...
                            <div className="para4 text-center absolute">
                                <h4 className="text-gray-500 font-body  pb-2 font-bold text-xl">I'm a Tenant</h4>
                                <p className="know-more-p  text-gray-500 font-body text-lg font-normalt pb-3 leading-5">
                                    Make this your. Add images, text and links, or
                                    <br/>
                                    connect data from your collection.
                                </p>
