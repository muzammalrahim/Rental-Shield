    ...
    render() {
        return (
            <div className="vision-main">
                <Container>
                    <h3 className="font-body text-6xl text-gray-500 font-normal pb-4">
                        Our Vision
                    </h3>
                    <p className="font-body text-2xl text-gray-500 font-normal leading-7 pb-3 px-10">
                    ...
                    <p className="font-body text-2xl text-gray-500 font-normal pb-3 leading-7 px-10">
                    ...
                    <p className="font-body text-2xl text-gray-500 font-normal leading-7">
