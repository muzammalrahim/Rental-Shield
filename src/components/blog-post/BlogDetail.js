        ...
        return (
            <div className="blog-detail">
                    <div className="blog-content px-40">
                        ...
                        <p className="text-3xl font-body font-bold text-gray-500 text-left leading-9 pt-4">
                        ...
                        <p className="text-green-500 font-body font-normal text-left text-3xl leading-8">
                        ...
                        <p className="text-gray-500 font-body text-left font-bold text-2lx leading-8"> 
